"""Dispute-adjudication agent — decide chargeback strategy on a SeatGeek Card dispute.
...
class DisputeAgent(BaseAgent):
    ...
    def build_messages(self, inputs: dict[str, Any]) -> tuple[str, str]:
        user = (
            "Adjudicate this SeatGeek Card dispute. Decide whether the cardholder should win "
            ...
            "is the dollar exposure SeatGeek carries if the cardholder wins."
        )
