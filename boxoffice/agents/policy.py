"""Policy-audit agent — replicate SeatGeek's spend-policy rulebook from natural language.
...
class PolicyAuditAgent(BaseAgent):
    ...
    def build_messages(self, inputs: dict[str, Any]) -> tuple[str, str]:
        ...
        user = (
            "Audit this SeatGeek Card transaction against company spend policy and list "
