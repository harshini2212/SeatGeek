...
class BaseAgent:
    ...
    persona = ("You are BoxOffice, SeatGeek's financial-correctness AI. You reason "
               "carefully about SeatGeek Card and SeatGeek Treasury activity and you NEVER guess "
