...
is this fraud, and what should SeatGeek do (freeze the card and open a dispute, open a
...
class FraudTriageAgent(BaseAgent):
    ...
    def build_messages(self, inputs: dict[str, Any]) -> tuple[str, str]:
        ...
        user = (
            "Triage this SeatGeek Card transaction for fraud using the model's risk score and "
