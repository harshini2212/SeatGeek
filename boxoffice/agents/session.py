...
_TAB_GUIDE = {
    ...
    "card_issuance": ("Issue a SeatGeek Card. Compile the request into a spec with propose_card, show "
...
def _system_prompt(persona: Persona, tab: str) -> str:
    return (
        f"You are BoxOffice, an AI finance analyst operating in {persona.label} mode "
