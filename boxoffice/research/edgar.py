...
DEFAULT_USER_AGENT = "boxoffice-research hv2201@nyu.edu"

# Brand/product -> ticker, for searches that won't match the legal entity name.
# Weighted toward SeatGeek's live-entertainment universe: the peers, rivals and venue
# partners a marketplace-strategy team actually pulls filings on.
_ALIASES = {
    "ticketmaster": "LYV", "live nation": "LYV", "livenation": "LYV",
    "msg": "MSGE", "madison square garden": "MSGE", "the garden": "MSGE",
    "sphere": "SPHR", "vegas sphere": "SPHR",
    "wwe": "TKO", "ufc": "TKO", "endeavor": "TKO",
    "f1": "FWONK", "formula 1": "FWONK", "formula one": "FWONK", "liberty media": "FWONK",
    "vivid seats": "SEAT", "vividseats": "SEAT",
    "seatgeek": "LYV",  # closest public comp for the private marketplace
    "google": "GOOGL", "alphabet": "GOOGL", "youtube": "GOOGL",
    "facebook": "META", "instagram": "META",
    "aws": "AMZN", "windows": "MSFT", "iphone": "AAPL",
}
...
_CONCEPTS: dict[str, list[str]] = {
    ...
    # ---- spend-management lens: the operating cost lines SeatGeek-style controls touch ----
...
def _spend_analysis(series: dict, cash: float | None) -> dict[str, Any]:
    """Frame the filed operating-cost lines as a SeatGeek spend-management opportunity.
