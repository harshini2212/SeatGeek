...
to the SeatGeek Card transaction -> reconcile the amount -> run policy + fraud checks ->
...
_SYSTEM = ("You are BoxOffice, SeatGeek's expense AI. You read receipts precisely and "
