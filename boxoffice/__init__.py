"""BoxOffice — agentic AI + financial-correctness evaluation for SeatGeek spend.

BoxOffice is an internal-style platform that (1) runs agentic AI workflows over
SeatGeek Card and SeatGeek Treasury data — expense triage, dispute resolution, fraud
