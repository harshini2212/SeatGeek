"""Enumerations modeling SeatGeek spend-management primitives."""
...
class CardType(str, Enum):
    PHYSICAL = "physical"
    VIRTUAL = "virtual"  # SeatGeek virtual cards (per-vendor, burner)
...
class EmployeeRole(str, Enum):
    ADMIN = "admin"  # SeatGeek admin (finance / ops)
    MANAGER = "manager"
    EMPLOYEE = "employee"
...
class ExpenseCategory(str, Enum):
    """SeatGeek expense categories used for accounting + policy."""
...
class CashTxnType(str, Enum):
    """SeatGeek Treasury money movement."""
    ...
    YIELD_ACCRUAL = "yield_accrual"  # SeatGeek Treasury yield
