...
def model_registry(dataset: Dataset, *, pipeline=None, underwriter=None,
    ...
    return [
        ...
        },
        {
            ...
            "description": "Links SeatGeek Cards by shared devices and cross-metro IPs; flags "
        ...
        },
        {
            ...
            "description": "Forecasts daily SeatGeek Treasury balance with weekly-seasonality features "
