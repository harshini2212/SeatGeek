...
Each module takes a :class:`~boxoffice.domain.models.Dataset` and produces decision-grade
output for one SeatGeek surface. Together with the fraud + eval stack they form the full
