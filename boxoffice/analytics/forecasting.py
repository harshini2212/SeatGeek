"""Treasury & cash-flow forecasting for the SeatGeek Business Account.

Reconstructs a daily cash-balance series from SeatGeek Treasury money-movement, then forecasts
...
(overnight sweep into the SeatGeek Treasury government money-market fund, ~4% APY).
"""
...
_MMF_APY = 0.041  # SeatGeek Treasury MMF (BNY Dreyfus Government, DGVXX) 7-day yield ballpark
...
class TreasuryForecaster:
    ...
    def _yield(self, current_balance: float, monthly_outflow: float) -> dict:
        # SeatGeek Treasury sweeps idle operating cash into a government MMF *overnight* and
        ...
        return {
            ...
            "recommendation": (
                f"Auto-sweep your ${operating:,.0f} operating balance into SeatGeek Treasury "
