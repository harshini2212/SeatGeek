...
The SeatGeek domain models card and cash activity; bills live in the AP workflow, so we
...
HHI, and payment-timing optimization — hold cash in the SeatGeek Treasury MMF until the due
...
class APIntelligence:
    ...
    def payment_timing(self) -> dict:
        ...
        return {
            ...
            "recommendation": (
                f"Hold ${sum(v.amount_usd for v in open_bills):,.0f} in SeatGeek Treasury until due "
